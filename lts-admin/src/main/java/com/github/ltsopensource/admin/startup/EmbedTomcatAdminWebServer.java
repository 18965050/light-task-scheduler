package com.github.ltsopensource.admin.startup;
 ...
 **/
public class EmbedTomcatAdminWebServer {

    private static final Logger log = LoggerFactory.getLogger(EmbedTomcatAdminWebServer.class);

    private static final String CONNECTOR_PORT = "8888";
    ...
    private static String getAbsolutePath() {
        String path = null;
        String folderPath = EmbedTomcatAdminWebServer.class.getProtectionDomain().getCodeSource().getLocation()
            .getPath();
